...
We can't use the regular released version of OpenBCI because its been modified of the OpenBCI GUI to take
...
#. Download ONLY VERSION 3.5.4 of  `Processing <https://processing.org/releases>`__ app
#. Using git, clone the custom fork of `OpenBCI_GUI <https://github.com/Cerelog-ESP-EEG/OpenBCI_GUI-Fork>`__

    .. code-block:: bash

       $ git clone https://github.com/Cerelog-ESP-EEG/OpenBCI_GUI-Fork.git

#. (This should be default branch but if not) Switch to the ``feature/lsl-input-and-clinical-eeg-bandpass-filter`` branch
